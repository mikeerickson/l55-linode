...
alias code="cd ~/code"
alias dev="cd ~/code"
alias ea="vi ~/code/home-aliases.sh"
alias g="gulp"
alias home="cd ~"
alias npm-global="npm list -g --depth 0"
alias ra="reload"
alias reload="source ~/code/home-aliases.sh && echo ==> Aliases Reloaded... \n"
alias run="npm run"
alias tree="xtree"
alias stats="cd ~/code/api-stats"
alias api="cd ~/code/api-stats"
